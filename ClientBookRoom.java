...
public class ClientBookRoom extends JFrame {
	 ...
	 */
	public ClientBookRoom(BookingInterface newBookingInterface) throws RemoteException {
	...
	private void initialiseUI(final BookingInterface bookingInterface) {
		...
		// When submit button is clicked, selected items are used to book desired room.
		validateButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				...
				try {
					...
					roomStatus = bookingInterface.bookAvailableRoom(submitRoomName, dayValue, timeValue);
